/*
MySQL - 5.7.22 : Database - otoken-service-admin
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`otoken-service-admin` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `otoken-service-admin`;
...
(
    ...
    corp_name varchar(100) DEFAULT 'oToken' NOT NULL COMMENT '归属集团Name',
